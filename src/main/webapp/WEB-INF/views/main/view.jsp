        ...
        <div class="cgt_detail_wrap">
                ...
                <div class="col-xs-7">
                    <div class="cgt_detail_contents">
                        <div class="col-xs-12 padding-left-clear">
                            ...
                            <div class="col-md-10 info-place">${view.address1}&nbsp;${view.address2}&nbsp;<!--<div style="float:right;"><a href="#" onclick="jQuery('a[data-target=#map]').click();return false;"><img src="/resources/image/main/btn_map.jpg" width="25" height="25"></a></div>--></div>
                            ...
                            <div class="col-md-10">
                                <div class="pull-left">
                                    ...
                                    <fmt:parseNumber value="${view.end_date.time / (1000*60*60*24)}" integerOnly="true" var="end"/> / ${(end - start) + 1}일간&nbsp;</div>
                            ...
                            <div class="col-md-10">
                                <c:if test="${!empty view.tag}">
                                    ...
                                    <c:forEach var="silceTags"  items="${tags}" varStatus="stat">
                                        <a href="/main/search/Tag/${silceTags}" target="_blank"><div class="cgt_detail_tag">${silceTags}</div></a>&nbsp;
                                        </c:forEach>
                                    </c:if>
                            </div>
                            <div class="clearfix"></div>
            ...
            <div style="width:100%;box-sizing:border-box;padding:0 40px">
                ...
                <div class="tab_container">
                    ...
                    <a data-target="#caution" data-toggle="tab">
                        <div class="pull-left cgt_detail_tab">구매 및 환불안내</div>
                    </a>
                    <a data-target="#map" data-toggle="tab" id="mapsel">
                        ...
                        <c:if test="${view.file_savname.split(',')[1] ne null}">
                            <div style="padding-top:20px">
                                <a href="javascript:" id="divBtnMore">
                                    <div style="border: 1px solid #DEDEDE;line-height:44px;width:100%;border-radius:3px;text-align:center;margin-top:20px;cursor:pointer"><div id="spItemMore">+ 더보기</div></div>
                                </a>
                                <div style="padding-top:20px">
