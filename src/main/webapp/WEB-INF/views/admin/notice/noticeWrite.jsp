                        ...
                        <!-- <s:else>
                            ...
                            <table align="center" class="table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="subject" size="60" maxlength="25" placeholder="제목을 입력하세요." class="form-control" id="subject"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="content" rows="10" placeholder="내용을 입력하세요." class="form-control" id="content"></textarea>
