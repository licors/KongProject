    ...
    <body>
        ...
        <form:form commandName="orderModel" name="detailForm" method="post"
            ...
            <table class="table">
                ...
                <tr>
                    <td class="col-md-10" style="text-align:right;" colspan="3"><font color="#FF0000"><b>*
                ...
                <tr>
                    <td class="col-md-2"><label for="id_email">ID(E-MAIL)</label></td>
                    <td class="col-md-8"><form:input path="id_email" class="form-control"
                                type="text" name="id_email" maxlength="70"
                                value="${orderModel.id_email}" readonly="true" /></td>
                </tr>
                <tr>
                    <td class="col-md-2"><label for="name">성명</label></td>
                    <td class="col-md-8"><form:input path="name" class="form-control" type="text"
                                name="name" value="${orderModel.name}"
                                readonly="true" /></td>
                </tr>
                <tr>
                    <td class="col-md-2"><label for="sex">성별</label></td>
                    <td class="col-md-8"><form:input path="sex" class="form-control" type="text"
                                name="sex" value="${orderModel.sex}"
                                readonly="true" /></td>
                </tr>
                <tr>
                    <td class="col-md-2"><label for="company">회사</label></td>
                    <td class="col-md-8"><form:input path="company" class="form-control"
                                type="text" name="company"
                                value="${orderModel.company}" readonly="true" /></td>
                </tr>
                <tr>
                    <td class="col-md-2"><label for="area">지역</label></td>
                    <td class="col-md-8"><form:input path="area" class="form-control" type="text"
                                name="area" value="${orderModel.area}"
                                readonly="true" /></td>
                </tr>
                <tr>
                    <td class="col-md-2"><label for="phone">전화번호</label></td>
                    <td class="col-md-8"><form:input path="phone" class="form-control"
                ...
                <tr>
                    <td class="col-md-2"><label for="payment_type">일반결제</label></td>
                    <td class="col-md-8"><form:input path="payment_type" class="form-control"
                                type="text" name="payment_type"
                                value="${orderModel.payment_type}" readonly="true" /></td>
                </tr>
                <tr>
                    <td class="col-md-2"><label for="bank_account">입금은행</label></td>
                    <td class="col-md-8"><form:input path="bank_account" class="form-control"
                                type="text" name="bank_account"
                                value="${orderModel.bank_account}" readonly="true" /></td>
                </tr>
                <tr>
                    <td class="col-md-2"><label for="payment_payer">입금자 명</label></td>
                    <td class="col-md-8"><form:input path="payment_payer" class="form-control"
                ...
                <tr>
                    <td class="col-md-2"><label for="tel">티켓(바코드)</label></td>
