		...
		<c:forEach var="list" items="${list}" varStatus="stat">
			<tr class="jsearch-row">
				...
				<td class="jsearch-field"
					...
					href="/admin/main/view/${list.showcase_num}">${list.subject}</a></td>
				<td class="jsearch-field"
					style="text-align: center; vertical-align: middle;">${list.showcase_category}</td>
				<td style="text-align: center; vertical-align: middle;"><jsp:useBean
						id="now" class="java.util.Date" /><fmt:parseNumber
						value="${list.start_date.time / (1000*60*60*24)}"
						integerOnly="true" var="start" />
					<fmt:parseNumber value="${now.time / (1000*60*60*24)}"
						integerOnly="true" var="end" /> <c:choose>
				...
				<td style="text-align: center; vertical-align: middle;"><a
					href="/admin/main/modify/${list.showcase_num}"><input
						type="image" alt="수정하기"
						src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Cog_font_awesome.svg/32px-Cog_font_awesome.svg.png"
						style="width: 16px"></a>&nbsp;&nbsp; <a href="#"
					onclick="return fnConfirmMoveUrl('정말로 삭제하시겠습니까?', '/admin/main/delete/${list.showcase_num}');"><input
						type="image" alt="삭제하기"
