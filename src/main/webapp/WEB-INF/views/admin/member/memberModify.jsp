    ...
    <section class="cgt-content-wrapper main-content clear-fix">
        <div style="padding-top:50px;">
            <div class="row" style="margin:0px;">
                ...
                <div class="col-md-6">
                    <form:form commandName="member" action="${contextPath}/member/admin/memberModify" method="post" name="modifyform" id="form0">
                        <div style="max-width:400px; text-align:left; margin:0px auto 40px auto;">
                        ...
                        <div style="max-width:1200px; margin:0px auto; padding-bottom:40px;">
                            <div class="container user_info">
                                <div class="clearfix" style="padding-bottom:10px;line-height:35px;">
                                    ...
                                    <div class="col-md-9">
                                        <form:input type="text" name="name" class="form-control search_box_input" path="name" onclick="this.value=''" style="width:300px;" /> 
                                        <font color="red">
                                ...
                                <div class="clearfix" style="padding-bottom:10px;line-height:35px;">
                                    ...
                                    <div class="col-md-9">
                                        <form:input type="text" name="company" class="form-control search_box_input" path="company" onclick="this.value=''" style="width:300px;" /> 
                                        <font color="red">
                                ...
                                <div class="clearfix" style="padding-bottom:10px;line-height:35px;">
                                    ...
                                    <div class="col-md-9">
                                        <form:input type="text" name="phone" class="form-control search_box_input" path="phone" onclick="this.value=''" style="width:300px;" /> 
                                        <font color="red">
                                ...
                                <div class="clearfix" style="padding-bottom:10px;line-height:35px;">
                                    ...
                                    <div class="col-md-9">
                                        <form:input type="password" class="form-control search_box_input" path="password" onclick="this.value=''" style="width:300px;" />
                                        <font color="red">
                                ...
                                <div style="max-width:1200px; text-align:center; margin:20px auto 40px auto;">
                                    ...
                                    <input class="btn btn-light-blue" type="button" style="display:inline-block; width:120px;" value="취소" onClick="javascript:location.href = '/member/admin/list'">
                                </div>
                            </div>
                        </div>
                    </form:form>
