...
<title>서비스 이용약관에 동의합니다.</title>
</head>
<body>
이용약관<br>
제 1 장 총 칙<br>
제 1 조 (목적)<br>
이 이용약관(이하 '약관')은 (주)KONG(이하 ‘회사’라 합니다)와 이용 고객(이하 '회원'이라고 합니다. )간에 회사가 제공하는 KONG(이하 ‘서비스’라 합니다.) 스마트폰 어플리케이션(이하 ‘앱’ 이라 합니다)과 웹사이트(이하 ‘웹’이라 합니다), 를 포함한 회사의 서비스(이하 ‘KONG 서비스’라 합니다) 의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.<br>
제 2 조 (이용약관의 효력 및 변경)<br>
(1) 이 약관은 KONG 서비스에서 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관 역시 KONG 서비스에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.<br>
(2) 회사는 합리적인 사유가 발생될 경우에는 이 약관을 변경할 수 있으며, 약관을 변경할 경우에는 지체 없이 이를 사전에 공시합니다.<br>
(3) 이 약관에 동의하는 것은 앱을 설치하거나 웹사이트에 가입할 때, 약관을 확인하여 동의함을 의미합니다. 변경된 약관에 대한 정보를 알지 못해 발생하는 이용자의 피해는 회사에서 책임지지 않습니다.<br>
...
1. '이용고객'이라 함은 KONG 서비스를 이용하는 이용자를 말합니다.<br>
2. ‘서비스’라 함은 KONG 스마트폰 앱과 웹사이트의 서비스를 말합니다.<br>
3. '이용계약'이라 함은 서비스 이용과 관련하여 회사와 이용고객 간에 체결 하는 계약 말합니다.<br>
제 2 장 이용계약 체결<br>
제 5 조 (이용 계약의 성립)<br>
(1) 이용계약은 이용고객의 본 이용약관 내용에 대한 동의함으로 성립합니다.<br>
(2) 본 이용약관에 대한 동의는 이용신청 당시 해당 KONG 서비스의 '동의함' 버튼을 누름으로써 의사표시를 합니다.<br>
제 6 조 (서비스 이용 신청)<br>
(1) 본 서비스를 이용하고자 하는 이용고객은 회사에서 요청하는 제반정보(성명, 전화번호 등)를 제공하여야 합니다.<br>
제 7 조 (개인정보의 보호 및 제공)<br>
(1) 회사는 관계법령이 정하는 바에 따라 이용자 등록정보를 포함한 이용자의 개인정보를 보호하기 위해 노력합니다. 이용자 개인정보의 보호 및 사용에 대해서는 관련법령 및 회사의 개인정보 보호정책이 적용됩니다. 단, 회사의 서비스에서 링크된 사이트에서는 회사의 개인정보 보호정책이 적용되지 않습니다. 또한 회사는 이용자의 귀책사유로 인해 노출된 정보에 대해서 일체의 책임을 지지 않습니다.<br>
(2) 회사는 회사의 개인정보 취급방침에 따라 이용고객이 제공한 개인정보, 관심정보를 마케팅의 목적으로 활용 및 제 3자에게 제공할 수 있습니다.<br>
제 8 조 (이용의 제한)<br>
(1) 회사는 아래사항에 해당하는 경우에 대해서 사용을 제한할 수 있습니다.<br>
- 사회의 안녕과 질서, 미풍양속을 저해할 목적으로 이용하는 경우<br>
- 부정한 용도로 본 서비스를 이용하고자 하는 경우<br>
- 기타 규정한 제반사항을 위반하며 이용하는 경우<br>
- 본 서비스와 경쟁관계에 있는 이용자가 이용하는 경우<br>
- 기타 규정한 제반사항을 위반하며 이용하는 경우<br>
(2) 회사는 서비스 이용이 다음 각 호에 해당하는 경우에는 이용고객에 대하여 공지하고 그 이용에 대하여 이용 제한사유가 해소될 때까지 이용을 유보할 수 있습니다.<br>
- 회사가 설비의 여유가 없는 경우<br>
- 회사의 기술상 지장이 있는 경우<br>
- 기타 회사의 귀책사유로 이용이 곤란한 경우<br>
제 9 조 (개인정보 등록 및 변경 등)<br>
(1) 핸드폰번호는 원칙적으로 변경이 불가하며 부득이한 사유로 인하여 변경 하고자 하는 경우에는 해당 앱을 삭제하고 재설치하거나, 웹사이트에서 변경해야합니다 .<br>
(2) 이용자가 서비스 개인정보의 관리를 소홀이 관리하여 발생하는 서비스 이용상의 손해 또는 제3자에 의한 부정이용 등에 대한 책임은 이용자에게 있으며 회사는 그에 대한 책임을 일절 지지 않습니다.<br>
(3) 기타 이용자 개인정보 관리 및 변경 등에 관한 사항은 서비스별 안내에 정하는 바에 의합니다.<br>
제 3 장 계약 당사자의 의무<br>
제 10 조 (회사의 의무)<br>
...
(3) 회사는 개인정보 보호를 위해 개인정보 관리책임자를 두고 보안시스템을 구축하며 개인정보 보호정책을 공시하고 준수합니다.<br>
...
(2) 회원은 회사의 사전 승낙 없이 서비스를 이용하여 영업활동을 할 수 없으며, 그 영업활동의 결과에 대해 회사는 책임을 지지 않습니다. 또한 회원은 이와 같은 영업활동으로 회사가 손해를 입은 경우, 회원은 회사에 대해 손해배상의무를 지며, 회사는 해당 회원에 대해 서비스 이용제한 및 적법한 절차를 거쳐 손해배상 등을 청구할 수 있습니다.<br>
(3) 회원은 회사의 명시적 동의가 없는 한 서비스의 이용권한, 기타 이용계약상의 지위를 타인에게 양도, 증여할 수 없으며 이를 담보로 제공할 수 없습니다.<br>
(4) 회원은 회사 및 제 3자의 지적 재산권을 침해해서는 안됩니다.<br>
(5) 회원은 다음 각 호에 해당하는 행위를 하여서는 안되며, 해당 행위를 하는 경우에 회사는 회원의 서비스 이용제한 및 적법 조치를 포함한 제재를 가할 수 있습니다.<br>
...
제 4 장 서비스의 이용<br>
제 12 조 (서비스 이용 시간)<br>
(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시중단은 KONG 서비스의 공지사항 또는 푸시알림 및 이메일 등을 통해 사전에 공지합니다.<br>
...
제 13 조 (개인정보 관리)<br>
(1) 회사와 이용고객은 회사의 개인정보 취급방침을 준수합니다.<br>
(2) 회사는 개인정보에 의하여 제반 이용자 관리업무를 수행 하므로 회원이 개인정보를 변경하고자 하는 경우 회사가 인정할 만한 사유가 없는 한 개인정보의 변경을 제한할 수 있습니다.<br>
(3) 이용고객의 귀책사유로 인한 개인정보 유출 또는 제 3자에 의한 부정사용 등에 대한 모든 책임은 해당 이용고객에게 있습니다.<br>
제 14 조 (게시물의 관리)<br>
...
제 16 조 (정보의 제공)<br>
(1) 회사는 회원에게 서비스 이용에 필요가 있다고 인정되는 각종 정보에 대해서 푸시알림 또는 전자우편이나 문자메시지 등의 방법으로 회원에게 제공할 수 있습니다.<br>
(2) 회사는 서비스 개선, 행사의 원활한 진행 및 회원 대상의 서비스 소개 등의 목적으로 회원의 동의 하에 추가적인 개인 정보를 요구할 수 있습니다.<br>
제 17 조 (광고게재 및 광고주와의 거래)<br>
(1) 회원은 서비스 이용시 노출되는 광고게재에 대해 동의합니다.<br>
...
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 스마트폰에서 회원탈퇴기능을 사용하여 탈퇴 할 수 있으며, 탈퇴 후에도 앱을 재설치 하거나, 앱에 재가입하여 정해진 가입절차에 따라 관련조항에 따라 회원으로 다시 가입할 수 있습니다. 단, 기존에 가입되었던 계정의 정보를 보호하기 위해 재가입을 일정기간 동안 제한할 수 있습니다.<br>
제 19 조 (서비스 이용제한)<br>
...
(2) 회사의 유료 서비스 이용 회원의 경우 회사가 별도로 정한 약관 및 정책에 따릅니다.<br>
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.<br>
                
[부칙]<br>
    (시행일) 본 약관은 2015년 12월 1일부터 적용됩니다.<br>
</body>
</html>