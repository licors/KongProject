...
public class PagingAction {
	...
	// Search있는 생성자
	public PagingAction(int currentPage, int totalCount, int blockCount, int blockPage,String torrentName, int searchNum, String isSearch){
...
/*			pagingHtml.append("<a href=" + torrentName + "?currentPage=" + (startPage - 1) + "&searchNum="+searchNum+ "&isSearch="+isSearch+">");*/
		...
		for(int i = startPage; i <= endPage; i++){
			...
			if(i == currentPage){
				...
				pagingHtml.append("<a href=" + torrentName + "?currentPage=" + i);
				if(isSearch != "")
